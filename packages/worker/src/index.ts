...
<head>
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .setup-skill{margin-bottom:0.75rem;background:var(--surface);border:1px solid var(--surface-hover);border-radius:10px;padding:0.875rem 1.25rem;display:flex;align-items:center;justify-content:space-between;gap:1rem;transition:border-color .2s}
    ...
    .setup-cli .setup-cli-header{display:flex;align-items:center;justify-content:space-between;gap:0.75rem;margin-bottom:0.5rem}
    .setup-cli .setup-cli-left{display:flex;align-items:baseline;gap:0.5rem;flex-wrap:wrap;min-width:0}
    ...
    .setup-cli .setup-cli-tabs{display:inline-flex;gap:1px;background:var(--code-bg);border-radius:5px;padding:2px;flex-shrink:0}
    .setup-cli .tab-btn{background:none;border:none;cursor:pointer;font-family:'SF Mono',Menlo,Consolas,monospace;font-size:0.625rem;color:var(--text-faintest);padding:0.2rem 0.55rem;border-radius:3px;transition:color .15s,background .15s}
    ...
    .setup-cli .cmd{display:flex;width:100%;min-width:0;align-items:center;background:var(--code-bg);border-radius:4px;padding:0.35rem 0.25rem 0.35rem 0.5rem;gap:0.25rem}
    .setup-cli .cmd .code-scroll{flex:1;min-width:0;overflow-x:auto;scrollbar-width:none}
    .setup-cli .cmd .code-scroll::-webkit-scrollbar{display:none}
    .setup-cli .cmd code{font-family:'SF Mono',Menlo,Consolas,monospace;font-size:0.6875rem;color:var(--text-faint);white-space:nowrap}
    .setup-cli .copy-btn{background:none;border:none;cursor:pointer;color:var(--text-faintest);padding:0.25rem;line-height:0;transition:color .15s,background .15s;display:flex;align-items:center;border-radius:3px;flex-shrink:0}
    ...
    @media(max-width:600px){
      ...
      .demo-arrow{width:auto;height:2rem;border-left:0;border-right:0;border-top:1px solid var(--border-medium);border-bottom:1px solid var(--border-medium);font-size:0;line-height:0}
  ...
  <div class="container">
    ...
    <section class="setup">
      ...
      <div class="setup-cli" id="cli-install">
        <div class="setup-cli-header">
          <div class="setup-cli-left"><span class="label">CLI</span><span class="desc">Install and publish from your terminal</span></div>
