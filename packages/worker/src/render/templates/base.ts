...
const BASE_CSS = `
  :root {
    ...
    --border-hover: #d1d5db;
    --accent: #4f46e5;
    --accent-ring: rgba(79,70,229,0.1);
    --syntax-key: #4f46e5;
    ...
    --shadow-img: 0 2px 8px rgba(0,0,0,0.1);
    --shadow-btn: 0 1px 3px rgba(0,0,0,0.06);
    --shadow-btn-hover: 0 2px 6px rgba(0,0,0,0.08);
  }
  @media (prefers-color-scheme: dark) {
    :root {
      ...
      --shadow-img: 0 2px 8px rgba(0,0,0,0.5);
      --shadow-btn: 0 1px 3px rgba(0,0,0,0.3);
      --shadow-btn-hover: 0 2px 6px rgba(0,0,0,0.4);
    }
  }
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .el-download-link:hover { background: var(--bg-hover); border-color: var(--border-hover); color: var(--text); box-shadow: var(--shadow-sm); }
  .el-download-link:active { background: var(--bg-active); transform: scale(0.97); }
...
const VIEWER_CSS: Record<ViewerType, string> = {
  csv: `
    ...
    th { background: var(--bg-elevated); font-weight: 600; color: var(--text-muted); font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.05em; cursor: pointer; user-select: none; position: sticky; top: 0; }
    ...
    .el-search { padding: 0.5rem 0.75rem; border: 1px solid var(--border); border-radius: 6px; font-size: 0.875rem; min-width: 240px; background: var(--bg-surface); color: var(--text); }
    .el-search:focus { outline: none; border-color: var(--accent); box-shadow: 0 0 0 3px var(--accent-ring); }
    .el-count { font-size: 0.8125rem; color: var(--text-faint); }
    .el-sort-icon { margin-left: 0.25rem; opacity: 0.4; }
    .el-sort-icon.active { opacity: 1; color: var(--accent); }
  `,
  markdown: `
    ...
    .el-prose code { background: var(--bg-code); padding: 0.15rem 0.4rem; border-radius: 3px; font-size: 0.875em; }
    .el-prose pre { background: var(--bg-code); color: var(--text); padding: 1rem 1.25rem; border-radius: 8px; overflow-x: auto; margin: 0 0 1rem; border: 1px solid var(--border); }
    .el-prose pre code { background: none; padding: 0; font-size: 0.8125rem; line-height: 1.7; }
    .el-prose blockquote { border-left: 3px solid var(--accent); padding-left: 1rem; color: var(--text-muted); margin: 0 0 1rem; }
    .el-prose a { color: var(--accent); text-decoration: none; }
    ...
    .el-prose th, .el-prose td { padding: 0.5rem 0.75rem; border: 1px solid var(--border); text-align: left; }
    .el-prose th { background: var(--bg-elevated); font-weight: 600; }
    .el-prose hr { border: none; border-top: 1px solid var(--border); margin: 2rem 0; }
  `,
  json: `
    .el-json { font-family: 'SF Mono', Monaco, 'Cascadia Code', monospace; font-size: 0.8125rem; line-height: 1.7; }
    .el-json-key { color: var(--syntax-key); }
    .el-json-string { color: var(--syntax-string); }
    .el-json-number { color: var(--syntax-number); }
    .el-json-bool { color: var(--syntax-bool); }
    .el-json-null { color: var(--syntax-null); }
    .el-json-toggle { cursor: pointer; user-select: none; }
    .el-json-toggle:hover { background: var(--bg-code); border-radius: 2px; }
    .el-json-collapsed .el-json-children { display: none; }
    .el-json-collapsed .el-json-preview { display: inline; }
    .el-json-preview { display: none; color: var(--text-faintest); font-style: italic; }
    .el-json-bracket { color: var(--syntax-bracket); }
  `,
  html: "",
  image: `
    .el-gallery { display: flex; align-items: center; justify-content: center; min-height: calc(100vh - 60px); padding: 2rem; }
    .el-gallery img { max-width: 100%; max-height: calc(100vh - 120px); object-fit: contain; border-radius: 8px; box-shadow: var(--shadow-img); cursor: zoom-in; }
    ...
    .el-gallery-btn { padding: 0.5rem 0.875rem; background: var(--bg-surface); border: 1px solid var(--border); border-radius: 8px; cursor: pointer; font-size: 0.8125rem; font-weight: 500; color: var(--text-muted); display: inline-flex; align-items: center; gap: 0.375rem; text-decoration: none; transition: all 0.15s ease; box-shadow: var(--shadow-btn); min-height: 36px; }
    .el-gallery-btn:hover { background: var(--bg-hover); border-color: var(--border-hover); color: var(--text); box-shadow: var(--shadow-btn-hover); }
  ...
  svg: `
    ...
    .el-svg-btn { padding: 0.5rem 0.75rem; background: var(--bg-surface); border: 1px solid var(--border); border-radius: 6px; cursor: pointer; font-size: 0.8125rem; color: var(--text); }
    .el-svg-btn:hover { background: var(--bg-hover); }
  `,
  mermaid: `
  ...
  download: `
    ...
    .el-download-card { padding: 2.5rem 3rem; background: var(--bg-surface); border: 1px solid var(--border); border-radius: 16px; box-shadow: var(--shadow-md); max-width: 400px; width: 100%; }
    .el-download-icon { margin-bottom: 1.25rem; display: flex; justify-content: center; }
    .el-download-icon svg { color: var(--text-faintest); }
    .el-download-name { font-size: 1rem; font-weight: 600; margin-bottom: 0.25rem; word-break: break-all; color: var(--text); }
    .el-download-meta { font-size: 0.8125rem; color: var(--text-faintest); margin-bottom: 1.75rem; }
    .el-download-btn { display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.625rem 1.25rem; background: var(--btn-primary-bg); color: var(--btn-primary-fg); border-radius: 8px; text-decoration: none; font-weight: 500; font-size: 0.875rem; transition: all 0.15s ease; min-height: 44px; }
    .el-download-btn:hover { background: var(--btn-primary-bg-hover); box-shadow: var(--shadow-btn-hover); }
  ...
  json: `
    (function() {
      ...
      try {
        ...
        container.innerHTML = '<pre style="padding:1rem;color:var(--syntax-bool)">Invalid JSON: ' + e.message + '</pre>';
      }
