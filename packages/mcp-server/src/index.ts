...
const toolDefinitions = [
  {
    ...
    description:
      "Publish raw content (Markdown, CSV, HTML, JSON, SVG, Mermaid) as a shareable page. The fastest way — content goes in, page comes out. Max 256KB.",
    inputSchema: {
  ...
  },
  {
    name: "publish_file",
    description:
      "Publish a single file from disk as a shareable page. easl auto-detects the file type and renders it with the best viewer.",
    inputSchema: {
      type: "object" as const,
      properties: {
